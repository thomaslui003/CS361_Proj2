...
imagev2 = rgb2gray(im2double(imread('plasticClip4.jpg')));
...
highcorv2 = cornernessv2.*(cornernessv2 > (1e-6)*5); %the bigger num the less corner it shows eg 1e-5  (had(1e-5)*6 before as setting)
...
colorImage2 = im2double(imread('plasticClip4.jpg'));
